...
set confhome=https://raw.githubusercontent.com/Ynkcc/reinstall/main
set confhome_cn=https://jihulab.com/Ynkcc/reinstall/-/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/Ynkcc/reinstall/main
